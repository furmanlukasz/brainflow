...
AntNeuroBoard_eego24::AntNeuroBoard_eego24 (int board_id, struct BrainFlowInputParams params)
...
AntNeuroBoard_eego24::~AntNeuroBoard_eego24 ()
{
    skip_logs = true;
    release_session ();
}

int AntNeuroBoard_eego24::prepare_session ()
{
    if (initialized)
    {
...
int AntNeuroBoard_eego24::start_stream (int buffer_size, const char *streamer_params)
{
    if (stream != NULL)
    {
...
int AntNeuroBoard_eego24::stop_stream ()
{
    if (stream != NULL)
    {
        keep_alive = false;
...
int AntNeuroBoard_eego24::release_session ()
{
    if (initialized)
    {
        stop_stream ();
...
void AntNeuroBoard_eego24::read_thread ()
{
...
int AntNeuroBoard_eego24::config_board (std::string config, std::string &response)
{
    if (amp == NULL)
    {
        safe_logger (spdlog::level::err, "Amplifier is not created");
